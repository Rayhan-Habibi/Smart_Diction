  ...
  return (
    <div className='flex items-center lg:p-0 p-5 justify-center flex-col bg-white backdrop-blur-sm rounded-xl z-0 mx-3'>
        <form className="flex items-center">
            <input onChange={handleChange} value={input} type="text" className='focus:outline-none border-2 border-black h-16 rounded-xl lg:w-96 text-2xl pl-14 bg-white/50 backdrop-blur-sm' placeholder='Browse' />
